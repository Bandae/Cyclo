...
db_creator.add_materials(os.path.join(DATA_PATH, 'wal_czynny-materialy.csv'))
db_creator.add_mounting_types()
db_creator.add_bearing_types()
db_creator.add_rolling_element_types()
db_creator.add_rolling_elements(os.path.join(DATA_PATH, 'wal_czynny-elementy_toczne-kulki.csv'), 1)
db_creator.add_rolling_elements(os.path.join(DATA_PATH, 'wal_czynny-elementy_toczne-waleczki.csv'), 2)
db_creator.add_rolling_elements(os.path.join(DATA_PATH, 'wal_czynny-elementy_toczne-igielki.csv'), 3)
db_creator.add_bearings(os.path.join(DATA_PATH, 'wal_czynny-lozyska-podporowe-kulkowe.csv'), 1, 1)
db_creator.add_bearings(os.path.join(DATA_PATH, 'wal_czynny-lozyska-podporowe-walcowe.csv'), 2, 2)
db_creator.add_bearings(os.path.join(DATA_PATH, 'wal_czynny-lozyska-centralne-walcowe.csv'), 3, 2, True)
db_creator.add_bearings(os.path.join(DATA_PATH, 'wal_czynny-lozyska-centralne-igielkowe.csv'), 4, 3, True)
